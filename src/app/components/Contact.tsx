...
export const Contact=()=>{
    return(
        <div id="Contact" className="w-screen bg-white text-black">
      ...
      <div className="grid lg:grid-cols-3 items-center">
        <div className="grid sm:grid-cols-2 gap-4 z-20 relative lg:left-16 max-lg:px-4">
          <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-7 fill-gold-500" viewBox="0 0 512 512">
          ...
          <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-7 fill-gold-500" viewBox="0 0 473.806 473.806">
          ...
          <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-7 fill-gold-500" viewBox="0 0 32 32">
          ...
          <div className="flex flex-col items-center justify-center rounded-lg w-full h-44 p-4 text-center bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)]">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-7 fill-gold-500" viewBox="0 0 100 100">
        ...
        <div className="lg:col-span-2 bg-gradient-to-r from-indigo-200 via-red-200 to-yellow-100 rounded-lg sm:p-10 p-4 z-10 max-lg:-order-1 max-lg:mb-8">
          <h2 className="text-3xl text-black text-center font-extrabold mb-6">Contact us</h2>
          <form>
