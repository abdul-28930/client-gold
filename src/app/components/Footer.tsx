...
export const Footer=()=>{
    ...
    return(
        ...
        <div>
         <footer className="bg-gradient-to-r from-yellow-200 via-yellow-300 to-yellow-400  text-black py-6 px-4 font-sans tracking-wide">
      <div className="text-center">
        ...
        <p className="text-base">© Gold Store(Hamdan). All rights reserved.</p>
      </div>
    </footer>
        </div>
    )
